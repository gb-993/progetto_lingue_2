// static/js/instruction_yes.js
// Mostra o nasconde il blocco "Instruction yes" in tempo reale
// quando l’utente seleziona YES / NO dal menu a tendina.
...
(function () {
  ...
  function toggleInstruction(qid, show) {
    const block = document.querySelector(
      '.yes-instruction-block[data-qid="' + qid + '"]'
    );
    if (!block) return;
  ...
  function onRespChange(e) {
    ...
    toggleInstruction(qid, value === "yes");
  }
