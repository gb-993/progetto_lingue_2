...
class ParameterForm(forms.ModelForm):
    ...
    class Meta:
        ...
        "description_of_the_implicational_condition": "Description of the implicational condition",
        ...
        widgets = {
            ...
            "description_of_the_implicational_condition": forms.Textarea(attrs={"class": "form-control", "rows": 3}),
