...
urlpatterns = [
    ...
    path("<str:lang_id>/instructions/", views.language_save_instructions, name="language_save_instructions"),
    ...
    path("<str:lang_id>/<str:question_id>/answer/", views.answer_save, name="answer_save"),
]
