...
## LANDING PAGE
- [x] Meglio togliere riferimenti politici dalla mappa
...
## PARAMETERS EDIT
- [x] Inserire uno spazio sotto a brief summary of changes in cui sono conservate tutte le descrizioni delle modifiche fatte per quel parametro (una sorta di cronologia dei cambiamenti)
...
## TABLE A
- [x] Nell'export xlsx di parameter view sostituire l'etichetta "Question text" con "Parameter", invece nell'export xlsx di question view sostituire l'etichetta "Parameter name" con "Question text"
